...
public class Grid {
    ...
    public SpatialModel<Double> getModel(InputStream file) {
        ...
        DataReader<SpatialModel<Double>> data =
                                       new DataReader<>(file, FileType.TEXT, s);

        return data.read();
    }

    /**
     * Predicate that, given two locations, converts them in at.ac.tuwien.cps.grid coordinates
     ...
     * @param size dimension of the (squared) at.ac.tuwien.cps.grid
     * @return the result of the comparison between the direction and the locations.
     */
    public static Boolean
    checkDirection(int nl, int ol, GridDirection dir, int size)
    {
    ...
    /**
     * Locally generated at.ac.tuwien.cps.grid
     * @return a spatial at.ac.tuwien.cps.grid of fixed size
     */
    ...
    /**
     * Generates an N x N at.ac.tuwien.cps.grid and returns a SpatialModel derived from it
     ...
     * @param size dimension of the (quadratic) at.ac.tuwien.cps.grid
     * @return a List of the serialized coordinates of the nodes.
     *
     * @see #toArray for details on the serialization technique
     */
    public static List<Integer>
    getNeighboursByDirection(int loc, GridDirection dir, int size)
    {
